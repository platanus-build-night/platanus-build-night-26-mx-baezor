  ...
  return (
    <div className="page">
      <header className="topbar">
        <div className="brand">
          <img className="brand-mark" src="/auris-mark.svg" alt="" width={36} height={36} />
          <div className="brand-text">
            <h1 className="au-h3 brand-name">Auris</h1>
            <p className="au-caption brand-tag">Ajustes del audio</p>
          </div>
        </div>
      </header>
      ...
      <footer className="footer">
        <p className="au-caption">
          Auris — motor abierto y autoalojable. Esta pantalla solo ajusta la
          configuración; no gestiona cuentas ni estudiantes.
        </p>
      </footer>
    </div>
  );
